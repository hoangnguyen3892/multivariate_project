...
# Find group of dog
print(breeds.index("American Bulldog"))
print(groups[15])
print("-------------")
print(breeds.index("American Staffordshire Terrier"))
print(groups[22])
print("-------------")
print(breeds.index("Australian Kelpie"))
print(groups[12])
print("-------------")
print(breeds.index("Black Mouth Cur"))
print(groups[5])
print("-------------")
print(breeds.index("Blue Lacy"))
print(groups[0])
print("-------------")
print(breeds.index("Cocker Spaniel"))
print(groups[74])
print("-------------")
print(breeds.index("English Bulldog"))
print(groups[14])
"""
# List of 100 smartest dogs
# https://pethelpful.com/dogs/100-smartest-dog-breeds

smart_dogs = ["Border Collie", "Poodle", "German Sherpherd", "Golden Retriever", "Doberman Pinscher", "Shetland Sheepdog",
              "Labrador Retriever", "Papillon", "Bloodhound", "Rottweiler"]